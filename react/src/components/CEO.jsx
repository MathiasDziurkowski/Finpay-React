        ...
        <div className='pt-52'>
            <div className="w-screen md:h-ceo justify-around rounded-xl bg-terciaria flex gap-12 ">
                ...
                <div className="flex flex-col align-middle absolute pl-36 md:relative justify-center gap-32 md:w-ceo">
                    ...
                    <div>
                        <h1 className="font-raleway pl-16 text-sm font-extrabold md:text-base md:pl-0">Ballapen Jack</h1>
                        <p className="font-raleway pl-16 text-sm text-slate-400 md:text-base md:pl-0">CEO Finpay</p>
                    </div>
                </div>
