export default function Cards() {
    return(
        <body className="flex flex-col items-center pt-48 gap-12">
            <h1 className="font-raleway text-7xl font-extrabold text-center">Bank Transfer payment,<br />demystified</h1>
            <p className="text-center font-raleway w-p ">"Say goodbye to long lines and complicated transactions. Bank smarter with secure and
            convenient online payments. Manage your money with ease, anytime, anywhere."</p>

            <div className="flex">
                <div className="flex items-end bg-primaria duration-150 ease-in-out w-cards h-cards hover:bg-secundaria">
